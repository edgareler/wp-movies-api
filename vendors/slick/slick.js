...
(function(factory) {
    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.options = jQuery.extend({}, _.defaults, dataSettings, settings);
    ...
    Slick.prototype.cleanUpEvents = function() {
        ...
        if (_.options.dots && _.$dots !== null) {
            ...
            if (_.options.pauseOnDotsHover === true && _.options.autoplay === true) {
                ...
                jQuery('li', _.$dots)
                    .off('mouseenter.slick', jQuery.proxy(_.setPaused, _, true))
                    .off('mouseleave.slick', jQuery.proxy(_.setPaused, _, false));
        ...
        _.$list.off('mouseenter.slick', jQuery.proxy(_.setPaused, _, true));
        _.$list.off('mouseleave.slick', jQuery.proxy(_.setPaused, _, false));
    ...
    Slick.prototype.initDotEvents = function() {
        ...
        if (_.options.dots === true && _.options.pauseOnDotsHover === true && _.options.autoplay === true) {
            jQuery('li', _.$dots)
                .on('mouseenter.slick', jQuery.proxy(_.setPaused, _, true))
                .on('mouseleave.slick', jQuery.proxy(_.setPaused, _, false));
        }
    ...
    Slick.prototype.initializeEvents = function() {
        ...
        _.$list.on('mouseenter.slick', jQuery.proxy(_.setPaused, _, true));
        _.$list.on('mouseleave.slick', jQuery.proxy(_.setPaused, _, false));
    ...
    Slick.prototype.setOption = Slick.prototype.slickSetOption = function(option, value, refresh) {
        ...
        if( option === "responsive" && jQuery.type(value) === "array" ) {
            for ( item in value ) {
